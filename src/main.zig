...
pub fn main(init: std.process.Init) !void {
    ...
    const file_owner = try arena.alloc(u32, n_files);
    {
        ...
        // Shared frozen base type store (ROADMAP §frozen-base piece 2): built
    ...
    for (0..n_files) |i| {
        ...
        // 5.5.4 lib is census-clean but trips a few ztsc-incompleteness
    ...
    if (cli.memory) {
        ...
        // Physical type-store footprint: the frozen base counted once
