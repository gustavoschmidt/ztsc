//! Module resolution, module graph, and cross-file symbol linking.
//!
//! Design decisions:
//!
...
/// Synthetic path of the injected ES-core lib. It has no on-disk
...
/// The embedded ES-core lib text (see `src/lib/lib.esnext.d.ts` — the
...
/// Synthetic path of the injected DOM lib. Loaded as an additional lib
...
pub fn link(
    ...
    // Cross-file global merge: fold every file's harvest slice.
    const sym_base = try computeSymBase(arena, files);
