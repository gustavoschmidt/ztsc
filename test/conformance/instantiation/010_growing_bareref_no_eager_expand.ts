...
// never a false positive. tsc reports TS2589 here; the snapshot keeps it and
// the divergence is registered in `test/conformance/DEFERRED` (identical
// handling to 003). If the strict-decrease guard regresses to eager expansion,
// this input diverges (spurious errors or nontermination).
