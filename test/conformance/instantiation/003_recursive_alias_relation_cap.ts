...
// that tsc accepts (e.g. real form-library `PathValue` shapes). The snapshot
// keeps the oracle's TS2589; the divergence is registered in
// `test/conformance/DEFERRED`. The case exists to ensure this input keeps
// *checking without crashing* and deterministically — if the cap regresses,
// this case stack-overflows and the suite crashes.
